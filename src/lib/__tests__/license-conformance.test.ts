 ...
 * before, and this repository carried the worst of the defects.
 * It shipped **64 lines** — it did not carry the GNU GPL v3 at all, only a short
 * notice and a gnu.org hyperlink. None of Sections 0–17, no patent grant, no
 * warranty disclaimer, no preamble. GPL §4 requires giving recipients a copy of
 * the licence; a link is a weak substitute. It also carried the retired
 * `Statistical PERT® Software Suite` brand on line 1, dead since the v1.4
 * rebrand in March 2026. Only GanttApp was in comparable shape, at 48 lines.
 *
...
const REPO_URL = 'https://github.com/famousdavis/spert-cfd';
